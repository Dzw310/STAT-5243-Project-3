...
FALLBACK_ARTICLES = [
    ...
    },
    {
        ...
        "full_summary": "In a column for the Columbia Spectator, senior Emma Zhang argues that the university should allow students to take at least one Core Curriculum course per year on a pass/fail basis. Zhang contends that the current grading structure discourages students from engaging deeply with unfamiliar material and instead promotes strategic grade optimization. She cites survey data showing that 62 percent of Columbia undergraduates have avoided participating in Core class discussions for fear of hurting their GPA.",
